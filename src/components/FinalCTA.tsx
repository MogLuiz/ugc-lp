...
export function FinalCTA() {
  return (
    <section className="py-16 lg:py-24 bg-gradient-to-b from-white via-accent/20 to-white relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-12">
        <div className="relative bg-gradient-to-br from-primary via-[#7C3AED] to-[#8B5CF6] rounded-[2rem] p-8 sm:p-12 lg:p-16 text-white overflow-hidden shadow-2xl shadow-primary/20">
          ...
          <div className="relative">
            ...
            <div className="max-w-3xl">
              <h2 className="text-[1.875rem] sm:text-[2.25rem] lg:text-[2.75rem] xl:text-[3.25rem] font-bold mb-5 leading-[1.05] tracking-tight">
                Encontre creators locais e comece a criar conteúdo
              </h2>

              <p className="text-[1rem] lg:text-[1.375rem] text-white/95 mb-6 leading-[1.6]">
              ...
              <div className="pt-5 border-t border-white/20 flex flex-wrap items-center gap-x-6 gap-y-3 text-sm font-medium text-white/90">
