      ...
      {mobileOpen && (
        <div className="md:hidden bg-white/95 backdrop-blur-xl border-t border-border/40 px-6 py-6 space-y-1">
          ...
          <div className="pt-4 border-t border-border/40 flex flex-col gap-3">
            <button className="w-full text-sm font-semibold px-5 py-3 text-foreground hover:bg-accent rounded-xl transition-colors border border-border/60">
              Sou creator
            </button>
            <button className="w-full text-sm font-semibold px-5 py-3 bg-primary text-primary-foreground rounded-xl hover:bg-primary/90 transition-all shadow-md shadow-primary/20">
              Para empresas
            </button>
          </div>
        </div>
